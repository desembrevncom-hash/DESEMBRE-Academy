...
import { academyAdminEnrollmentApi, AcademyEnrollment, AcademyEnrollmentStatus } from "@/features/admin/services/academyAdminEnrollmentApi";
                  ...
                  <tr key={enrollment.id} className="hover:bg-slate-50/50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="font-medium text-slate-900">
                        {enrollment.student.customer_id 
                          ? `Cust: ${shortId(enrollment.student.customer_id)}`
                          : `Acc: ${shortId(enrollment.student.id)}`}
                      </div>
                      <div className="text-xs text-slate-500">
                        Auth: {shortId(enrollment.student.user_id)}
                      </div>
                    </td>
                    <td className="px-6 py-4">
