...
import { Loader2, Calendar, MessageSquare, ArrowRight, AlertCircle, UserCheck, HelpCircle, Layers, Award, Users, Building2, Stethoscope, Sparkles } from "lucide-react";
...
function DynamicLandingPage() {
  ...
  useEffect(() => {
    loadLandingData();
    trackLandingEvent("campaign_landing_view", { slug });
  }, [slug]);
  ...
  return (
    <div className="min-h-screen bg-slate-50/60 pb-24 font-sans antialiased text-slate-900">
      ...
      <main className="container mx-auto px-4 max-w-5xl py-10 sm:py-14 space-y-10 sm:space-y-12">
        ...
        {/* 4. Trust Section */}
        {landing.trust_items && landing.trust_items.length > 0 && (
