...
const schema = z.object({
  phone: z.string().refine((val) => normalizePhone(val) !== null, {
    message: "Số điện thoại không hợp lệ (hỗ trợ các mạng Viettel, Vina, Mobi...)",
  }),
});
            ...
            <div className="relative h-full">
              ...
              <div className="relative flex h-full flex-col justify-end p-8 text-white">
                ...
                <p className="mt-3 max-w-sm text-white/85">
                  Đăng nhập bằng số điện thoại để vào hệ thống học tập.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mx-auto max-w-sm">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="mt-8 space-y-5" noValidate>
                ...
                <div className="flex items-center gap-2 text-xs text-muted-foreground">
                  ...
                  Mã xác thực OTP sẽ được gửi qua Zalo/SMS.
                </div>
