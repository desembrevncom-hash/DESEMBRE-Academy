...
export function SectionHeading({
  ...
  return (
    <div
      className={`flex flex-col gap-3 ${center ? "items-center text-center" : "sm:flex-row sm:items-end sm:justify-between"}`}
    >
      <div>
        {eyebrow && (
        ...
        <h2 className={`mt-3 text-2xl sm:text-3xl font-bold tracking-tight ${center ? "" : ""}`}>
          {title}
        </h2>
        {description && (
