...
function testStrictPrivacySanitization() {
  ...
  const mockPayload = {
    ...
    url: "https://academy.desembre-vn.com/l/biological-trigger?secret_token=abc&full_name=Nguyen%20A",
    href: "https://academy.desembre-vn.com/l/biological-trigger?secret_token=abc",
    utm_source: "facebook",
    utm_medium: "cpc_ads",
