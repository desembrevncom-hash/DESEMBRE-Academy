-- P3C.34 — Public Data Guard RPCs Migration Patch
-- File: scratch/p3c34_public_data_guard_rpcs.sql
...
BEGIN
  ...
  WHERE LOWER(TRIM(COALESCE(b.registration_status, b.status, 'draft'))) = 'open'
